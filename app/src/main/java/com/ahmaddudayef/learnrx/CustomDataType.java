...
public class CustomDataType extends AppCompatActivity {
    /**
    ...
    private static final String TAG = CustomDataType.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_daa_type);
        ...
        disposable.add(getNotesObservable()
                ...
                .map(new Function<Note, Note>() {
                    ...
                    public Note apply(Note note) throws Exception {
                        note.setNotes(note.getNotes().toUpperCase());
                        return note;
                    }
                })
